...
local workspace_dir = '/home/jed/workspace/' .. project_name
--                                               ^^
...
local config = {
  ...
  cmd = {
    ...
    -- 💀
    '-jar', vim.fn.glob('~/Tools/jdt-language-server-1.9.0-202203031534/plugins/org.eclipse.equinox.launcher_*.jar'),
         -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    '-configuration', '~/Tools/jdt-language-server-1.9.0-202203031534/config_linux',
                    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
